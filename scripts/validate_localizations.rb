...
reviewed_direct_values = {
  ...
  ["Encounter Note", "tr"] => "Karşılaşma Notu",
  ...
  ["Support", "tr"] => "Destek",
  ["Support, Privacy & About", "tr"] => "Destek, Gizlilik ve Hakkında",
  ["Get help or contact us on catlocal.app.", "tr"] => "catlocal.app üzerinden yardım alın veya bize ulaşın.",
  ...
  ["Unplaced", "tr"] => "Anı Yeri Olmayanlar",
